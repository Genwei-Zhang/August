...
public class ChatActivity extends AppCompatActivity {
    ...
    private void InitializeControllers() {
        ...
        LayoutInflater layoutInflater = (LayoutInflater) this.getSystemService(LAYOUT_INFLATER_SERVICE); // if anything goes wrong, might be here with Context.LAYOUT_INFLATER_SERVICE
